...
CREATE TABLE `activity_logs` (
  ...
  `related_object_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `agents` (
  ...
  `type` enum('ai','human','bot') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ai',
...
CREATE TABLE `goals` (
  ...
  `completion_criteria` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `llm_messages` (
  ...
  `sender` enum('user','llm') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
